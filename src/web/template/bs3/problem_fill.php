        ...
        <div class="jumbotron">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    if ($row_fill['problem_flag'] == "0") {
                        echo "<span class=green>$MSG_Time_Limit: </span>" . $row['time_limit'] . " Sec&nbsp;&nbsp;";
                        echo "<span class=green>$MSG_Memory_Limit: </span>" . $row['memory_limit'] . " MB<br>";
                    }
                    if (isset($total) && isset($ac)) {
                        echo "<span class=green>$MSG_SUBMIT: </span>" . $total . "&nbsp;&nbsp;";
                    ...
                    if ($row_fill['problem_flag'] == "0") echo "<span class=red>[代码填空题]</span>&nbsp;";
                    else if ($row_fill['problem_flag'] == "1") echo "<span class=red>[结果填空题]</span>&nbsp;";
                    if ($pr_flag) {
					...
					<?php }*/
                        if ($row['output'] && $row_fill['problem_flag'] == "1") { ?>
                            <div class='panel panel-default'>
                                <div class='panel-heading'>
                                    <h4>
                                        <?php echo $MSG_Output ?>
                        ...
                        <?php }
                        if ($row_fill['problem_tempcode'] && $row_fill['problem_flag'] == "0") { ?>
                            <div class='panel panel-default'>
                                <div class='panel-heading'>
                                    <h4>
                                        <?php echo "缺空代码(代码语言为：" . $language_name[$row_fill['language']] . "）" ?>
                                        <a href="javascript:CopyToClipboard($('#problem_tempcode').text())">Copy</a>
                                    </h4>
                                </div>
                                <div class='panel-body'>
                                    <pre class=content><span id='problem_tempcode' class=sampledata><?php echo $row_fill['problem_tempcode'] ?></span></pre>
                                </div>
                            </div>
                        ...
                        if (strlen($sinput) && $row_fill['problem_flag'] == "0") { ?>
                            <div class='panel panel-default'>
                                <div class='panel-heading'>
                                    <h4>
                        ...
                        <?php }
                        if (strlen($soutput) && $row_fill['problem_flag'] == "0") { ?>
                            <div class='panel panel-default'>
                                <div class='panel-heading'>
                                    <h4>
  ...
  ================================================== -->
        ...
        <script>
            ...
            function CreateElementForExecCommand(textToClipboard) {
                ...
                // place outside the visible area放置在可见区域之外
                forExecElement.style.position = "absolute";
                forExecElement.style.left = "-10000px";
                forExecElement.style.top = "-10000px";
                // write the necessary text into the element and append to the document将必要的文本写入元素并附加到文档
                forExecElement.textContent = textToClipboard;
                document.body.appendChild(forExecElement);
                // the contentEditable mode is necessary for the  execCommand method in FirefoxFirefox中的execCommand方法需要contentEditable模式
