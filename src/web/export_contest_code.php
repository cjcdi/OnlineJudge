<?php
        ...
        $sql="select user_id,problem_id,result,source from source_code right join (select solution_id,problem_id,user_id,result from solution where contest_id=? ) S on source_code.solution_id=S.solution_id order by S.solution_id";
