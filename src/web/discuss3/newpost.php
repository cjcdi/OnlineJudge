<?php
	require_once("oj-header.php"); //用来打开缓存输出

	if (!isset($_SESSION[$OJ_NAME.'_'.'user_id'])){ //判断用户是否登陆
		echo "<a href=../loginpage.php>Please Login First</a>";
		require_once("../template/$OJ_TEMPLATE/discuss.php"); //结束缓存输出，并打印
		exit(0);
	}
...
<center>
	<div style="width:90%; text-align:left">
		<h2 style="margin:0px 10px">Post New Thread
			<?php if (array_key_exists('cid',$_REQUEST) && $_REQUEST['cid']!='') echo ' For Contest '.intval($_REQUEST['cid']);?>	
		</h2>
