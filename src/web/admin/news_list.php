...
<div class='container'>
  <?php
    ...
    $row = $result[0]; //获取所有的键，键有ids和0
    $ids = intval($row['ids']);//获取值，两个值都是2

    $idsperpage = 25;
    $pages = intval(ceil($ids/$idsperpage)); //设置页数
  ...
  if(!(isset($_GET['keyword']) && $_GET['keyword']!=""))
    {
      ...
      echo "<li class='page-item'><a href='news_list.php?page=".(strval(1))."'>&lt;&lt;</a></li>"; //strval — 获取变量的字符串值
