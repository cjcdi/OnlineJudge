    ...
    <div class="container">
          ...
          <?php if($is_ok && $row_fill['problem_flag'] == "0"){ ?>
            ...
            <p align=left>
              ...
              <?php if($OJ_ACE_EDITOR){ ?>
                <pre style="width:80%;height:600" cols=180 rows=20 id="tempsource"><?php echo htmlentities($tempsource,ENT_QUOTES,"UTF-8")?></pre><br><!--编辑题目时会导进代码-->
      ...
      <?php
        ...
        if(get_magic_quotes_gpc()){
          ...
          if(!isset($problem_flag)) $input = stripslashes($input);
